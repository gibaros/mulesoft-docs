...
Using a PingFederate or OpenAM provider is recommended. If you do not want to contract with an organization, such as PingFederate or OpenAM, you need to build a Mule OAuth provider. 
